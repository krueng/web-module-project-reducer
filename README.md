...
* [x] Within `./reducers/index,` add in a case for `CLEAR_DISPLAY`. Clear disxlay should set the total value in state to 0.
...
- [ ] [Here is an example](https://freshman.txch/calculator/) of a (non-reducer) approach to building an javascript calculator. Feel free to make a new branch and use the basic ideas in the post to build a new version of the calculator.
